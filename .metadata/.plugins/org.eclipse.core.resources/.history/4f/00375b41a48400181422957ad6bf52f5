...
import com.review.exceptions.NoPoemException;
...
public class BeanieBabyServiceImpl implements BeanieBabyService{
	...
	@Override
	public String addBeanieBaby(BeanieBaby beanieBaby) throws NoPoemException {
		if(beanieBaby.getPoem().equals("")) {
			throw new NoPoemException("Doesn't have a poem");
		}
		return beanieBaby.getName()+" has been added to your collection";
	}
